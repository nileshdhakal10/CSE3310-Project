    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reff1.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                ...
                if(dataSnapshot.child("blPressure") == null)
                {
                    blPress = 0;
                }
                else
                {
                    blPress = Integer.valueOf(dataSnapshot.child("blPressure").getValue().toString());
                }
                ...
                else if (blPress>=120 && blPress<=129)
                {
                    blPressureMsg = "Elevated.\nAdopt a health lifestyle.";
                }
                else if (blPress>=130 && blPress<=139)
                {
