    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SaveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText blPressure = (EditText) findViewById(R.id.blPressureBox);
                int blPress = Integer.valueOf(blPressure.getText().toString().trim());
                ...
                vital_signs.setBlPressure(blPress);
